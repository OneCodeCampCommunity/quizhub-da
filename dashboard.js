...
function loadQuiz(topic) {
  ...
  const questions = {
    ...
    "Python Essentials": [
      ...
      {
        question:
          "Defined as a container to store data.",
        choices: ["variable", "git start", "git create", "git setup"],
        answer: "variable",
      },
      {
        question: "A reusable block of code that can be executed whenever needed.",
        choices: ["git push", "git pull", "git clone", "git fetch"],
        answer: "git clone",
      },
      {
        question: "A storage area that allows you to store multiple items inside of square brackets.",
        choices: ["lists", "git prepare", "git add", "git commit"],
        answer: "lists",
      },
      {
        question: "A storage are that allows you to store multiple items inside of a pair of parenthesis, and is immutable",
        choices: ["Tuple", "git push", "git stage", "git add"],
        answer: "git commit",
      },
      {
        question:
          "Built in function used to checn the data type of a variable",
    ...
    SQL: [
      ...
      {
        question:
          "Command used to SELECT multiple data inside the database.",
    ...
    "Pandas Intermediate": [
      ...
      {
        question:
          "Which property is used to define the space between grid items?",
        choices: ["grid-gap", "grid-spacing", "grid-margin", "grid-padding"],
        answer: "grid-gap",
      },
      {
        question:
